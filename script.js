...
// გამოიყენეთ Promise მეთოდი, ისე როგორც ლექციაზე გავაკეთეთ.

// const myPromise = function (str) {
//   return new Promise((resolve, reject) => {
//     if (str.length < 10) {
//       setTimeout(() => {
//         resolve("string is less than 10");
//       }, 5000);
//     } else {
//       setTimeout(() => {
//         reject("string is more than 10");
//       }, 5000);
//     }
//   });
// };
// const myNewPromise = function (str) {
//   return new Promise((resolve, reject) => {
//     if (str.length > 10) {
//       setTimeout(() => {
//         resolve("string is more than 10");
//       }, 5000);
//     } else {
//       setTimeout(() => {
//         reject("string is less than 10");
//       }, 5000);
//     }
//   });
// };
// Promise.all([myPromise("luka"), myNewPromise("vighacisdidisaxeli")])
//   .then((response) => {
